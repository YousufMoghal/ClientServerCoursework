...
public class SensorReadingResource {
    ...
    public List<SensorReading> getAllReadings() {
        ...
        List<SensorReading> readings = DatabaseStorage.SENSOR_READINGS.get(sensorId);

        if (readings == null) {
            readings = new ArrayList<>();
            DatabaseStorage.SENSOR_READINGS.put(sensorId, readings);
        }
    ...
    public Response addReading(SensorReading reading) {
        ...
        if (reading == null) {
            throw new IllegalArgumentException("Reading data is required.");
        }
